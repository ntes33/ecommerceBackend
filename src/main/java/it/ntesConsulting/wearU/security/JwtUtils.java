...
public class JwtUtils {
	...
	private String secreteJwtString;// Make sure the value in the application propertiers is 32character or long
    ...
    // refernt extration ( email)
	public String getUsernameFromToken(String token) {

		return extractClaims(token, Claims::getSubject);

	}
     //extration specific data from token
